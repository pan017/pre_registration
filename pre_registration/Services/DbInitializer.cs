           ...
           if (!context.Areas.Any())
            {
                context.Areas.AddRange(
                    new Area { Name = "Мингорисполком", Adres = "пр-т Независимости, 8", email = "mingor@mgaon.by", NotificationEmail = "mingor@mgaon.by", Phone = "+375 17 2180194, +375 17 2000460, +375 17 2180088", website = "https://minsk.gov.by/", WorkTime = "", MapUrl = "https://yandex.ua/map-widget/v1/-/CBuq6Qgd~A" },
